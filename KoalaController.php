...
class KoalaController extends V4Controller {
  ...
  public function search() {
    ...
    $data = self::_cache_search("https://www.kitapkoala.com/index.php?p=Products&q_field_active=0&ctg_id=&q=" . $post_text . "&search=&q_field=");
  ...
  private static function _query_bests_2($query_url) {
    ...
    preg_match_all("'<div class=\"image image_b\">(.*?)<noscript>'si", $file, $all_prices_percent);
    $_all_prices_percent = $all_prices_percent[1];
